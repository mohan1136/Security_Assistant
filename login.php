...
<?php
	...
	if(isset($_POST['login']))
	{
		...
		else
		{
			...
			$query="SELECT name FROM security_officers WHERE id='$id'and password='$password'";
			...
			$query="SELECT name FROM security_officers WHERE name='$id'and password='$password'";
			$output=mysqli_query($connection,$query);
			if($row=mysqli_fetch_array($output))
			{
				$_SESSION['id']=$row[0];
			...
			else $error='Enter correct username and password';
		}
	}
?>
		<style>
	...
	<body>
		<div class="login" align="center">
			...
			<p class="main">Security Login</p><br>
			<div class="form">
				<form method="post" name="Login">
					<table>
						...
						<tr><td align="center"><br><a href="admin_login.php">Login as admin</a></td></tr>
					</table>
				</form>
			</div>
			<br><p id="note"></p><br>
